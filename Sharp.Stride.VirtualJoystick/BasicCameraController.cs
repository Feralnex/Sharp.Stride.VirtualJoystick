...
namespace Sharp.Stride.VirtualJoystick
{
    ...
    public class BasicCameraController : SyncScript
    {
        ...
        public IVirtualJoystick VirtualJoystick { get; set; }
        ...
        public override void Start()
        {
            ...
            VirtualJoystick.StartedDragging += OnStartedDragging;
            VirtualJoystick.StoppedDragging += OnStoppedDragging;
        }
        ...
        private void OnStartedDragging(Vector2 obj)
            => dragging = true;

        private void OnStoppedDragging(Vector2 obj)
            => dragging = false;
        ...
        private void ProcessInput()
        {
            ...
            // Keyboard, Gamepad and VirtualJoystick based movement
            {
                ...
                if (VirtualJoystick is not null)
                {
                    dir.X += VirtualJoystick.RelativeInput.X;
                    dir.Z += VirtualJoystick.RelativeInput.Y;
                }
